                ...
                "NotificationsPage.useEffect.fetchNotifications": async ()=>{
                    ...
                    if (error) {
                        ...
                        const formattedNotifications = data.map({
                            "NotificationsPage.useEffect.fetchNotifications.formattedNotifications": (claim)=>({
                                    id: claim.id,
                                    claimant_name: claim.claimant.full_name || 'An unknown user',
                                    item_name: claim.item.name,
                                    created_at: claim.created_at
                                })
                        }["NotificationsPage.useEffect.fetchNotifications.formattedNotifications"]);
...
_s(NotificationsPage, "1W6nmyWe3fUF3/c+k9bF+1rLQOc=", false, function() {
    return [
...
//# sourceMappingURL=_b0cf1c30._.js.map