...
function LoginForm() {
    ...
    async function onSubmit(values) {
        ...
        setError(null);
        try {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.signInWithPassword(values);
...
_s(LoginForm, "VEhYsqRnUmkBo0mobnIK8ERWbbw=", false, function() {
    return [
...
//# sourceMappingURL=src_components_f84901a1._.js.map